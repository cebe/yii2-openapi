...
abstract class Alldbdatatype extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            'safe' => [['text_col_array', 'bytea_col_2', 'bit_col', 'bit_2', 'bit_3', 'ti', 'int2_col', 'smallserial_col', 'serial2_col', 'si_col', 'si_col_2', 'bi', 'bi2', 'int4_col', 'bigserial_col', 'bigserial_col_2', 'int_col', 'int_col_2', 'bit_varying', 'bit_varying_n', 'bit_varying_n_2', 'bit_varying_n_3', 'bool_col', 'bool_col_2', 'json_col', 'jsonb_col', 'json_col_def', 'json_col_def_2', 'bytea_def', 'json_def', 'jsonb_def', 'pg_lsn_col', 'serial_col', 'serial4_col'], 'safe'],
        ];
    }
}
