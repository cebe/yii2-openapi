...
class m200000_000000_create_table_alldbdatatypes extends \yii\db\Migration
{
    public function safeUp()
    {
        $this->createTable('{{%alldbdatatypes}}', [
            ...
            63 => 'bytea_def bytea NULL DEFAULT \'the bytea blob default\'',
            64 => 'text_def text NULL DEFAULT \'the text\'',
            65 => 'json_def json NOT NULL DEFAULT \'{"a":"b"}\'',
            66 => 'jsonb_def jsonb NOT NULL DEFAULT \'{"ba":"bb"}\'',
            67 => 'cidr_col cidr NULL DEFAULT NULL',
            68 => 'circle_col circle NULL DEFAULT NULL',
            69 => 'date_col_z date NULL DEFAULT NULL',
            70 => 'float8_col float8 NULL DEFAULT NULL',
            71 => 'inet_col inet NULL DEFAULT NULL',
            72 => 'interval_col interval NULL DEFAULT NULL',
            73 => 'interval_col_2 interval year NULL DEFAULT NULL',
            74 => 'interval_col_3 interval day to second(3) NULL DEFAULT NULL',
            75 => 'line_col line NULL DEFAULT NULL',
            76 => 'lseg_col lseg NULL DEFAULT NULL',
            77 => 'macaddr_col macaddr NULL DEFAULT NULL',
            78 => 'money_col money NULL DEFAULT NULL',
            79 => 'path_col path NULL DEFAULT NULL',
            80 => 'pg_lsn_col pg_lsn NULL DEFAULT NULL',
            81 => 'point_col point NULL DEFAULT NULL',
            82 => 'polygon_col polygon NULL DEFAULT NULL',
            83 => 'serial_col serial NOT NULL',
            84 => 'serial4_col serial4 NOT NULL',
            85 => 'tsquery_col tsquery NULL DEFAULT NULL',
            86 => 'tsvector_col tsvector NULL',
            87 => 'txid_snapshot_col txid_snapshot NULL DEFAULT NULL',
            88 => 'uuid_col uuid NULL DEFAULT NULL',
            89 => 'xml_col xml NULL DEFAULT NULL',
        ]);
    }
